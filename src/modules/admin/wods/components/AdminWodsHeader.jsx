...
export default function AdminWodsHeader({
  dashboardCopy,
  copy,
  locale,
  setLocale,
  ...
  return (
    <header className="admin-dashboard-header">
      ...
      <div className="admin-dashboard-heading">
        ...
        <h1>{copy.titleLead} <em>{copy.titleAccent}</em></h1>
        <p>{copy.subtitle}</p>
      </div>
      ...
      <div className="admin-dashboard-header-actions">
        ...
        <div className="admin-header-profile">
          ...
          <div>
            ...
            <small>{role === "coach" ? dashboardCopy.coachRole : dashboardCopy.adminRole}</small>
          </div>
        </div>
      </div>
    </header>
